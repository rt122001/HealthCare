	                ...
	                <div class="row">
	                    ...
	                    <div class="col-md-12">
	                    	<div class="card card-plain">
								...
								$sql = "SELECT username,name,age,gender,occupation,mobile,address,symptoms,status from users";
								...
								echo '<table class="table table-hover"><thead class="text-primary"><th>PATIENT ID</th><th>NAME</th><th>AGE</th><th>GENDER</th><th>OCCUPATION</th><th>MOBILE</th><th>ADDRESS</th><th>SYMPTOMS</th><th>STATUS</th></thead>';
