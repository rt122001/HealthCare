...
while(($line = fgetcsv($f)) !== false)
{
    ...
    if($d == "none"){
        if($line[2]!="Symptom")
            {$disease = $disease.$line[2].' .';}
    }
    
}
fclose($f);

echo "<h4>Probable Disease : $disease </h4><br>";

echo "<center><h4>Do you want to forward this result?</h4><br>";
?>
...
<input type="hidden" name="disease" value="<?php echo htmlspecialchars($disease); ?>"/>
