                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    ...
                                    <p class="category">Profile updated</p>
                                </div>
...
$str="update users set age='$age',gender='$gender',occupation='$occupation',address='$address' WHERE username='$username'";

$res=@mysql_query($str)or die(mysql_error());
if($res>=0)
{
echo'<br><br>Your Profile has been updated.<br>';
}
